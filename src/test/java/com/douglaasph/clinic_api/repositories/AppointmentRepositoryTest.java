...
class AppointmentRepositoryTest {
    ...
    void findByPatientOrEmployeeEmailCase1() {
        ...
        this.testEntityFactory.createAppointment(patient, employee, createAppointmentDto);

        List<PatientEmployeeAppointmentResponseDto> byPatientEmailList = this.repository.findByPatientEmail(emailPatient);
